...
STUDY = ROOT / 'art/studies/toyota-trail/04-all-terrain'
...
assert tyres['after'] > tyres['before'] * 1.08
shock = info['shock']
def length(travel):
...
print('PASS: eight unchanged planar panes; taller tyres retain rim diameter; LOD and shock lengths agree')
