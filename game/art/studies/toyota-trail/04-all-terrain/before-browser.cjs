// Toyota-only study. Compare the curved glazing with the corrected flat glazing in one
...
const revision = '03-flat-glazing';
...
const report = { capturedAt: new Date().toISOString(), viewport: { width: 1600, height: 1000 },
  revision,
  method: 'Unmodified production WebGL canvas. The curved-glazing sample and flat-glazing correction share one frozen vehicle pose, environment time, camera and sand paint. Baseline comparison concerns appearance only; the subsequent candidate drive runs real physics.',
